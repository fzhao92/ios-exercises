...
// Add 5 to this array
// WORK HERE
var mutableNumArr = numberArray
mutableNumArr.append(5)
...
func favoriteDrinksArrayForCharacters(characters:[[String : String]]) -> [String] {
    ...
    for character in characters{
        if let unwrappedChar = character["favorite drink"]{
            drinks.append(unwrappedChar)
        }
    }
    return drinks
}
...
func emailFromUserDict(userDict : [String : String]) -> String {
    ...
    // WORK HERE
    if let userEmailExists = userDict["email"]{
...
func putSemicolon(strings: [String]) -> String{
    var str = ""
...
// WORK HERE
let sortedCerealArray = cerealArray.sort( { (cereal1: String, cereal2: String) -> Bool in
